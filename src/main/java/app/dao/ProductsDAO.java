...
public class ProductsDAO extends EntitiesDAO<Product> {
    ...
    public void create(Product product) {
        executeQueryAndSaveStatistics(() -> em.persist(product), CREATE);
    }

    public List<Product> readAll() {
        TypedQuery<Product> generatedQuery = em.createQuery("SELECT pr FROM Product pr ORDER BY pr.productId", Product.class);
        return executeQueryAndSaveStatistics(generatedQuery::getResultList, READ);
    }
    ...
    public void delete(short productId) {
        ...
        executeQueryAndSaveStatistics((Runnable) generatedQuery::executeUpdate, DELETE);
    }
    ...
    public List<Product> readAllUsingNativeSql() {
        ...
        return executeQueryAndSaveStatistics(() -> (List<Product>) nativeQuery.getResultList(), NATIVE_READ);
    }
    ...
    public Product readByIdUsingNativeSql(short productId) {
        ...
        return executeQueryAndSaveStatistics(() -> (Product) nativeQuery.getSingleResult(), NATIVE_READ);
    }
